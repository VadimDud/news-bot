...
STRATEGIES = {
    ...
    "elliott_candles": {
        "name": "Эллиотт микро-волны (лонг + усреднение hold-add)",
        "cls": None,
        "params": [
            ...
            {"key": "quality_min", "label": "Фильтр качества волны 0..1 (0 = выкл)", "type": "float", "default": 0.6},
            ...
            {"key": "hold_add", "label": "Минус: держать и добавить на open след. свечи (суммарно ≤100%, 1 = да)", "type": "int", "default": 1},
            ...
            {"key": "slippage", "label": "Слайпедж на сторону (0.0005 = 0.05%)", "type": "float", "default": 0.0005},
        ],
    },
    "kinetic": {
